...
def add_kafka_datasource(dataset_name, dataset_title, owner_org, kafka_topic, kafka_host, kafka_port, dataset_description):
    """
    Add a Kafka dataset and its associated resource to CKAN.
