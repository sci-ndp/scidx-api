...
class ProducerPayload(BaseModel):
    ...
    match_all: bool = Field(False, example=False, description="Specifies whether all keywords must match (true) or if matching any one keyword (false) is sufficient.")
